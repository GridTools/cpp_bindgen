...
namespace cpp_bindgen {
    namespace _impl {
        ...
        template <>
        struct fortran_array_element_kind_impl<double> : std::integral_constant<gt_fortran_array_kind, gt_fk_Double> {};
        template <>
    ...
    namespace get_fortran_view_meta_impl {
        ...
        enable_if_t<std::is_array<Arr>::value && std::is_arithmetic<ElementType>::value, gt_fortran_array_descriptor>

...
bindgen_fortran_string_descriptor inline bindgen_make_fortran_string_view(
    bindgen_fortran_string_descriptor desc, bindgen_fortran_string_descriptor *) {
    return desc;
}
...
namespace cpp_bindgen {
    namespace fortran_string_view_impl_ {
        ...
        template <class T>
        struct is_fortran_string_bindable<T,
            typename std::enable_if<std::is_convertible<decltype(make_fortran_string_view<typename std::decay<T>::type>(
                                                            std::declval<bindgen_fortran_string_descriptor>())),
